#!/usr/bin/env node
/**
 * Teardown Uptime Kuma Proxmox LXC deployment.
 *
...
import { resolveOciInstanceForDeployment } from "hdc/package/oci-vm-deploy.mjs";
...
async function main() {
  errout.write(`[hdc] ${target} ${verb}: tear down Uptime Kuma LXC (stderr log; JSON on stdout).\n`);
