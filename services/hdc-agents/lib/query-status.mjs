...
import { composeDir, hostPort, parsePublicUrl } from "./hdc-agents-render.mjs";
 ...
 */
export async function queryHdcAgentsInCt(user, pveHost, vmid, hdcAgents, install) {
  const cfg = isObject(hdcAgents) ? hdcAgents : {};
