...
import { composeDir, hostPort, parsePublicUrl } from "./openspeedtest-render.mjs";
 ...
 */
export async function queryOpenspeedtestInCt(user, pveHost, vmid, openspeedtest, install) {
  const cfg = isObject(openspeedtest) ? openspeedtest : {};
