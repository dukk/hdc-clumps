...
import { composeDir, hostPort, parsePublicUrl } from "./paperless-ngx-render.mjs";
 ...
 */
export async function queryPaperlessNgxInCt(user, pveHost, vmid, paperless, install) {
