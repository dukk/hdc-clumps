...
import { composeDir, hostPort, normalizePublicUrl } from "./draw-io-render.mjs";
 ...
 */
export async function queryDrawIoInCt(user, pveHost, vmid, drawIo, install) {
  const dio = isObject(drawIo) ? drawIo : {};
  const port = hostPort(dio);
