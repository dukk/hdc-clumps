...
import { maintainTwentyInCt, maintainTwentyInQemu, resolvePveSshForHost } from "hdc/package/twenty-install.mjs";
...
async function main() {
  ...
  let secrets;
  try {
    secrets = await resolveTwentySecrets(vault, defaultsTwenty, { allowGenerate: false });
  } catch (e) {
