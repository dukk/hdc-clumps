...
import { composeDir, hostPort, parsePublicUrl } from "./omni-tools-render.mjs";
 ...
 */
export async function queryOmniToolsInCt(user, pveHost, vmid, OmniTools, install) {
  const cfg = isObject(OmniTools) ? OmniTools : {};
