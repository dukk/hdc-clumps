#!/usr/bin/env node
/**
 * Teardown omni-tools Proxmox LXC deployments.
 *
 * Usage: hdc run service omni-tools teardown -- [--instance a | --system-id omni-tools-a]
 *        hdc run service omni-tools teardown -- [--dry-run] [--yes] [--skip-compose-down]
 */
...
import { composeDownInCt, resolvePveSshForHost } from "hdc/package/omni-tools-install.mjs";
...
async function main() {
  errout.write(`[hdc] ${target} ${verb}: tear down omni-tools LXC (stderr log; JSON on stdout).\n`);
