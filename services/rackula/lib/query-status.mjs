...
import { composeDir, hostPort, parsePublicUrl } from "./rackula-render.mjs";
 ...
 */
export async function queryRackulaInCt(user, pveHost, vmid, rackula, install) {
  const cfg = isObject(rackula) ? rackula : {};
