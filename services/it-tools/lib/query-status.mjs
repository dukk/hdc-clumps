...
import { composeDir, hostPort, parsePublicUrl } from "./it-tools-render.mjs";
 ...
 */
export async function queryItToolsInCt(user, pveHost, vmid, itTools, install) {
  const cfg = isObject(itTools) ? itTools : {};
