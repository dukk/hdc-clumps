...
import { composeDownInCt, resolvePveSshForHost } from "hdc/package/wallabag-install.mjs";
...
async function main() {
  errout.write(`[hdc] ${target} ${verb}: tear down wallabag LXC (stderr log; JSON on stdout).\n`);
